...
A NoteInterval is used to transform a Note into a new Note.  (Note + NoteInterval => Note)
<pre><code>
...
NoteIntervals can be added together.  (NoteInterval + NoteInterval => NoteInterval)
<pre><code>
...
harmonized_chord(root_degree,degrees) => Chord
<pre><code>

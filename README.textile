...
A Note has an Integer value indicating its place on the chromatic scale. 
...
As demonstrated above, the NoteIntervals applied to the root
...
The major scale has been included as a class method.  Notice

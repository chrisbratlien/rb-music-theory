...
While I find this very useful, it's also hard to explain.  So please 
watch the following <a href="http://www.youtube.com/watch?v=fjDGl4GJosI">YouTube Video</a>

Given a Scale, you may describe a Chord, by its degrees, to be "walked" up the scale such that
only Notes in that Scale are used.

As in that YouTube video, I'll demonstrate a maj7 chord by using the degrees [1,3,5,7]

class NoteInterval
  ...
  def self.whole_tone_set
    [0, 2, 4, 6, 8, 10].map{|n| NoteInterval.new(n)}
  end
  
  def self.diminished_set
    [0, 2, 3, 5, 6, 8, 9, 11].map{|n| NoteInterval.new(n)}
  end    

  def self.major_pentatonic_set
    [0, 2, 4, 7, 9].map{|n| NoteInterval.new(n)}
  end    
  ...
  def self.major_neapolitan_set
    [0,1,3,5,7,9,11].map{|n| NoteInterval.new(n)}
  end    

  def self.minor_neapolitan_set
    [0,1,3,5,7,8,11].map{|n| NoteInterval.new(n)}
  end    

  def self.minor_hungarian_set
    [0,2,3,6,7,8,11].map{|n| NoteInterval.new(n)}
  end    
